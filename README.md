...
[![Search API Pantheon](https://github.com/pantheon-systems/search_api_fedsolr_pantheon/actions/workflows/ci.yml/badge.svg?branch=8.x)](https://github.com/pantheon-systems/search_api_fedsolr_pantheon/actions/workflows/ci.yml)
...
```
composer require pantheon-systems/search_api_fedsolr_pantheon ^8 --prefer-dist
```
...
Bug reports, feature requests, and feedback should be posted in [the drupal.org issue queue.](https://www.drupal.org/project/issues/search_api_fedsolr_pantheon?categories=All) For code changes, please submit pull requests against the [GitHub repository](https://github.com/pantheon-systems/search_api_fedsolr_pantheon) rather than posting patches to drupal.org.
