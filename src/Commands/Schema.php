...
namespace Drupal\search_api_fedsolr_pantheon\Commands;

use Drupal\Core\Logger\LoggerChannelFactoryInterface;
use Drupal\Core\Logger\LoggerChannelTrait;
use Drupal\search_api_fedsolr_pantheon\Plugin\SolrConnector\PantheonSolrConnector;
use Drupal\search_api_fedsolr_pantheon\Services\PantheonGuzzle;
use Drupal\search_api_fedsolr_pantheon\Services\SchemaPoster;
...
class Schema extends DrushCommands {
   ...
   *
   * @var \Drupal\search_api_fedsolr_pantheon\Services\SchemaPoster
   */
   ...
   * @param \Drupal\search_api_fedsolr_pantheon\Services\PantheonGuzzle $pantheonGuzzle
   *   Injected by container.
   * @param \Drupal\search_api_fedsolr_pantheon\Services\SchemaPoster $schemaPoster
   *   Injected by Container.
   */
