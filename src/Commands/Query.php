...
use Drupal\search_api_fedsolr_pantheon\Services\Endpoint;
use Drupal\search_api_fedsolr_pantheon\Services\PantheonGuzzle;
use Drupal\search_api_fedsolr_pantheon\Services\SolariumClient;
...
class Query extends DrushCommands {
   ...
   *   Injected by container.
   * @param \Drupal\search_api_fedsolr_pantheon\Services\Endpoint $endpoint
   *   Injected by container.
   * @param \Drupal\search_api_fedsolr_pantheon\Services\SolariumClient $solariumClient
   *   Injected by container.
   */
  ...
  /**
   * search_api_fedsolr_pantheon:select.
   *
   ...
   * @throws \Exception
   */
  public function forceServerClean($server_id = 'pantheon_fed_solr8') {
