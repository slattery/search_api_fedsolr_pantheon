...
namespace Drupal\search_api_fedsolr_pantheon\Plugin\SolrConnector;
...
use Drupal\search_api_fedsolr_pantheon\Services\Endpoint as PantheonEndpoint;
use Psr\Log\LoggerAwareInterface;
use Psr\Log\LoggerAwareTrait;
use Solarium\Client as SolariumClient;
use Solarium\Core\Client\Endpoint;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\search_api_fedsolr_pantheon\Services\PantheonGuzzle;
use Drupal\search_api_fedsolr_pantheon\Services\SolariumClient as PantheonSolariumClient;
 ...
 * @SolrConnector(
 *   id = "pantheon",
 *   label = @Translation("Pantheon FedSearch Connector"),
 *   description = @Translation("Connection to another Pantheon Search server interface")
 * )
 */
class PantheonSolrConnector extends SolrConnectorPluginBase implements
   ...
   *
   * @var \Drupal\search_api_fedsolr_pantheon\Services\PantheonGuzzle
   */
   ...
   *
   * @var \Drupal\search_api_fedsolr_pantheon\Services\SolariumClient
   */
  ...
  public function __construct(
    ...
    // ARE THESE SO EARLY THAT I HAVE NO CHANCE?  THEN WHY FORM?
   ...
   *
   * @return \Drupal\search_api\Plugin\ConfigurablePluginBase|\Drupal\search_api_fedsolr_pantheon\Plugin\SolrConnector\PantheonSolrConnector|static
   * @throws \Exception
   */
  public static function create(
    ...
    return new static(
          ...
          $container->get('search_api_fedsolr_pantheon.pantheon_guzzle'),
          $container->get('search_api_fedsolr_pantheon.solarium_client'),
  ...
  public static function getPlatformConfig() {
    // I THINK PANTHEON JUMPS THE LINE, SO HOW CAN I MAKE IT POLITE
    // THIS NEEDS TO EXIST FIRST, AS A CONFIG ENTITY THEN
    // SOMEDAY ALLOW ONE SOLR SERVER CHOICE PER ENTITY FOUND
    return [
      'scheme' => $this->configuration['platform_config']['scheme'],
      'host' => $this->configuration['platform_config']['host'],
      'port' => $this->configuration['platform_config']['port'],
      'path' => $this->configuration['platform_config']['path'],
      'core' => $this->configuration['platform_config']['core'],
      'schema' => $this->configuration['platform_config']['schema'],
    ];
  }

  /**
   * Returns TRUE if all platform-related configuration values are present.
   * someday get site and see if settings are owned by same account.
   * @return bool
  ...
  public function buildConfigurationForm(
    ...
    $form = parent::buildConfigurationForm($form, $form_state);
     // WAS GOING TO ADD CONFIG HERE, BUT FOR NOW GO WITH CONFIG ENTITY
     // STUCK WITH ONE PER SERVER FOR NOW BOOOOO
     // MAYBE NEED TO ADD TYPE PER SERVER LIKE 'CLOUD' or 'PANTHEON' which is ew
    $fields = [
      'timeout',
  ...
  public function submitConfigurationForm(
    ...
    // HEY I NEED TO BRING SCHEMA BACK???
