...
namespace Drupal\search_api_fedsolr_pantheon\Services;
 ...
 *
 * @package Drupal\search_api_fedsolr_pantheon
 */
class SchemaPoster implements LoggerAwareInterface {
   ...
   *
   * @param string $server_id
   *   The Search API server id. Typically, `pantheon_fed_solr8`.
   *
   * @return array
   ...
   * @throws \Drupal\Component\Plugin\Exception\InvalidPluginDefinitionException
   */
  public function getSolrFiles(string $server_id = 'pantheon_fed_solr8') {
  ...
  public function getSolrFilesAsZip(string $server_id) {
    ...
    $temp_dir =
            ...
            DIRECTORY_SEPARATOR .
            uniqid('search_api_fedsolr_pantheon-');
